      ...
      <div className="nav-btns nav-text ml-8">
        ...
        {user ? (
          <>
            ...
            <div onClick={handleShow1} className="relative">
              <img
                width={30}
                height={30}
                ...
                alt=""
              />
              <IoIosArrowDown color="green" className="absolute top-7 left-2" />
        ...
        <div className="image-nav relative ">
          <img
          ...
          {show1 && (
            <div className="lang mt-3 p-2  w-48 right-0  absolute  border rounded-lg top-8 bg-slate-400">
