...
import BlogCard from "../../components/mainBlogoCard";
...
const Blog = () => {
  ...
  return (
    <div className="lg:py-6 2xl:py-9 px-6 lg:px-14 2xl:px-28 flex primary flex-col gap-8">
    <div className="flex flex-col gap-5 text-center md:text-left items-center md:items-start">
        ...
        <h5 className="text-4xl leading-tight text-slate-400 font-bold md:max-w-lg">
