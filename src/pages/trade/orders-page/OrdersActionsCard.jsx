...
const ActionsCard = () => {
  return (
    <section className="mr-8 flex flex-wrap gap-2 flex-row justify-between p-4 text-xs">
        <div className="text-green-600 p-1 flex flex-wrap gap-6 ">
            ...
            <button className="border border-green-600 rounded-full py-2 px-5 mr-3 hover:bg-green-600 hover:text-white">Feedback (8)</button>
