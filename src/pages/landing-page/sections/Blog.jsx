  ...
  return (
    <div className="lg:py-6 2xl:py-9 px-6 lg:px-14 2xl:px-28 flex flex-col gap-8">
      <div className="flex flex-col gap-5 text-center md:text-left items-center md:items-start">
        ...
        <h5 className="text-4xl text-white leading-tight font-bold md:max-w-lg">
          Enjoy Our <span className="text-[#1D8751]">Blog</span> On the{" "}
          <span className="text-[#1D8751]">Latest Company Updates</span>
        </h5>
        <div className="flex items-center w-fit justify-between gap-10">

          <form className="flex items-center w-fit justify-between">
            <div className="flex items-center w-fit justify-between">
              <label
                className={`cursor-pointer flex items-center gap-2 px-4 py-2.5 ${value === "news" && "bg-[#1D8751] text-white"
              ...
              <label
                className={`cursor-pointer flex items-center gap-2 px-4 py-2.5 ${value === "blog" && "bg-[#1D8751] text-white"
          ...
          <div style={{ float: 'left', marginLeft: '47rem' }}>
            <input type="text" placeholder="search"  style={{background:'grey',height:'2rem',width:'23rem',
          borderRadius:'0.5rem', border:'1px solid greenun  '}}/>
          </div>
        </div>
      </div>
