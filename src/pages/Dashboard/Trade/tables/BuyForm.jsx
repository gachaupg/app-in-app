  ...
  return (
    <div className="flex wrap small items-center justify-center">
      ...
      >
        ...
        <div
          className="flex flex-col p-1 mr-20 gap-3  items-start"
          style={{
            width: "40%",
          }}
        >
          ...
          {show >= payments.min_order_amount && show <= payments.max_order_amount ? "" : <p className="text-red-700">{payments.min_order_amount} -{payments.max_order_amount}</p>}
